...
import { CreateUploadAttachmentUseCase } from "./create-upload-attachment";
...
let sut: CreateUploadAttachmentUseCase;
...
describe("Upload and create attachment", () => {
  beforeEach(() => {
    ...
    sut = new CreateUploadAttachmentUseCase(
      inMemoryUploadAttachment,
      fakeUploader
    );
  });
